...
while true
    ...
    output = [msg, ' ', string];
    DrawFormattedText_mod(windowPtr,'How confident are you (1-9)','center',y0-100,[0 0 0],0);
    DrawFormattedText_mod(windowPtr,'Type in a confidence value and press [Enter]','center',y0+100,[0 0 0],0);
