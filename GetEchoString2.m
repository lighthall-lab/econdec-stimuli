function string = GetEchoString2(windowPtr, msg, x, y, x0, y0, textColor, bgColor, useKbCheck, img, varargin)
...
while true
    ...
    output = [msg, ' ', string];
    DrawFormattedText_mod(windowPtr,'Probability that this is a','center',y0-100,[0 0 0],0);
    DrawFormattedText_mod(windowPtr,'good stock (0-100)','center',y0-60,[0 0 0],0);
    DrawFormattedText_mod(windowPtr,'Type in a probability value and press [Enter]','center',y0+100,[0 0 0],0);
